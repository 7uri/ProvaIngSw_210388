...
public class FunnyAlgorithms {
    ...
    public int stringToIntConverter(String number) throws UnsupportedOperationException {
        if(number.isEmpty()) throw new IllegalArgumentException("Numero assente!");
        ...
        if(numero < -32768 || numero > 32768) throw new IllegalArgumentException("Numero fuori dal range!");
